...
const layers: { num: string; name: string; desc: string; icon: string; color: string; chips: Chip[] }[] = [
  ...
  },
  {
    ...
    color: 'var(--ink-900)',
    chips: [
      { t: 'PII redaction',        d: 'Aadhaar · PAN · UPI', ci: 'M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z' },
  ...
  },
  {
    ...
    chips: [
      ...
      { t: 'India stack',      d: 'GST · MCA · AA · Tally',       ci: 'M12 2 2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5' },
